...
public class EventController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    else if (action.equalsIgnoreCase("listUser"))
        {
            ...
            sess.setAttribute("Cat_Id",Cat_Id);
            request.setAttribute("events", dao.getAllEvents(Cat_Id));
        }
        ...
        {
	    	forward = LIST_USER;
	    	String ItemName = request.getParameter("item1");
	    	int ItemPrice = Integer.parseInt(request.getParameter("item2"));
	    	int Cat_Id = (Integer)sess.getAttribute("Cat_Id");
	    	
	    	dao.addItem(Cat_Id,ItemName,ItemPrice);

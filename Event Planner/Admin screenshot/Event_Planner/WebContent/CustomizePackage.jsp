...
function validate1()
{
	str = document.customizepack.price1.value;
	alert(str);
	if(str == "")
	{
		return false;
...
<script type="text/javascript">
 ...
 <section id="portfolio">
		...
		<form name="customizepack" action="customize" method="get">
		<div class="container">					
				<%
			...
			<div class="row">
		           <div class="form-group col-lg-offset-9">
				   		<input type="submit" name="RSubmit" value="Next" onclick="return validate1()" class="btn btn-success btn-lg">
		           </div>
		    </div>
		</div>
		</form>
